...
Partial Class examples_example_A_507_default
    ...
    Protected Sub AccessDataSource1_Deleted(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceStatusEventArgs) Handles AccessDataSource1.Deleted
        ...
        If (Not String.IsNullOrEmpty(picture1FileName)) Then
            ...
            Dim picture1FilePath_main As String = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_507/picture1/main/"), picture1FileName)
            If (System.IO.File.Exists(picture1FilePath_main)) Then
                System.IO.File.Delete(picture1FilePath_main)
            End If

            ' Delete the thumbnail
            Dim picture1FilePath_thumbnail As String = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_507/picture1/thumbnail/"), picture1FileName)

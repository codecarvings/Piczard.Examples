<%@ Page Title="Piczard Examples | Image manipulation | Apply a text watermark" Language="VB" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="examples_example_A_223_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageBody" Runat="Server">
    <div class="pageContainer">
        ...
        <script type="text/javascript">
            ...
            {
                var hexValue = $("#<% =Me.txtForeColor.ClientID %>").val();

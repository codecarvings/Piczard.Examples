...
Partial Class examples_example_A_405_default
    ...
    Protected Sub btnSelectWholeImage_Click(ByVal sender As Object, ByVal e As EventArgs)
        ' Select the whole image
        Me.PopupPictureTrimmer1.Value.ImageSelection.Crop.Rectangle = Nothing

...
Partial Class examples_example_A_506_default
    ...
    Protected Sub AccessDataSource1_Deleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.SqlDataSourceCommandEventArgs) Handles AccessDataSource1.Deleting
        ...
        If (Not String.IsNullOrEmpty(picture1FileName)) Then
            ...
            Dim picture1FilePath_upload As String = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_506/picture1/upload/"), picture1FileName)
            If (System.IO.File.Exists(picture1FilePath_upload)) Then
                System.IO.File.Delete(picture1FilePath_upload)
            End If

            ' Delete the main image
            Dim picture1FilePath_main As String = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_506/picture1/main/"), picture1FileName)
            If (System.IO.File.Exists(picture1FilePath_main)) Then
                System.IO.File.Delete(picture1FilePath_main)
            End If

            ' Delete the thumbnail
            Dim picture1FilePath_thumbnail As String = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_506/picture1/thumbnail/"), picture1FileName)

<%@ Page Title="Piczard Examples | Web - Image Upload Demos | SimpleImageUpload Control - Usage example #5" Language="VB" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="examples_example_A_506_default" %>
    ...
    <div class="pageContainer">
        ...
        <div style="border:solid 1px #54691d; padding:10px;">
            ...
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="<%$ ConnectionStrings:Db1ConnectionString %>"
                ...
                DeleteCommand="DELETE FROM [Ex_A_506] WHERE [Id]=@Id">
                <DeleteParameters>

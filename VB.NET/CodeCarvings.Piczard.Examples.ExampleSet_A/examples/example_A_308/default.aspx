<%@ Page Title="Piczard Examples | Web - PictureTrimmer | Apply filters to the selected image" Language="VB" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="examples_example_A_308_default" %>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                <div class="InlinePanel1" style="padding:5px; margin-bottom:10px;">
                    <asp:Button runat="server" ID="btnProcessImage" Text="Apply filters &raquo;" CausesValidation="false" />
                </div>

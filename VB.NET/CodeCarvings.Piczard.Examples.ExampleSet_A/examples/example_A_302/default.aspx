<%@ Page Title="Piczard Examples | Web - PictureTrimmer | Crop enabled" Language="VB" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="examples_example_A_302_default" %>
            ...
            <ContentTemplate>
                <div class="InlinePanel1" style="padding:5px; margin-bottom:10px;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                            <tr>
                                ...
                                <td align="left" valign="middle">
                                    <asp:DropDownList runat="server" ID="ddlUnit" AutoPostBack="true">
                    ...
                    <asp:PlaceHolder runat="server" ID="phAfterLoad" Visible="false">
                        <asp:Button runat="server" ID="btnUnloadImage" Text="Unload image" CausesValidation="false" />
                    </asp:PlaceHolder>
                </div>

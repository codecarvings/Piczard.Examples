<%@ Page Title="Piczard Examples | Customize Piczard | Dynamic content image &amp; GUI expansion" Language="VB" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="examples_example_A_404_default" %>
    ...
    <div class="pageContainer">
        ...
        <script type="text/javascript">
            ...
            function zoomFactorChange()
            {
                ...
                // Set the zoom factor
                userState.uiParams.zoomFactor = parseFloat($("#<% =Me.ddlZoomFactor.ClientID %>").val());
            ...
            function initializeExampleUI()
            {
                ...
                $("#<% =Me.ddlZoomFactor.ClientID %>").change(function()
                {

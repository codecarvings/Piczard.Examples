<%@ Page Title="Piczard Examples | Basics | Load & save image files" Language="VB" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="examples_example_A_103_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageBody" Runat="Server">
    <div class="pageContainer">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">    
                        ...
                        <tr>
                            <td align="center" valign="top" class="ExampleTableProcessBottomCell">
                                ...
                                <br />
                                <br />
                                <asp:Button runat="server" ID="btnProcess" Text="Preview &raquo;" CausesValidation="false" /><br />
                                <br />
                                <br />
                            </td>
                        </tr>
                                ...
                                <asp:PlaceHolder runat="server" ID="phOutputPreview" Visible="false">
                                    <div style="width:580px;">
                                        <div style="float:left; margin: 10px;">
                                            ...
                                            <br />
                                            <div style="width:260px; height:173px; overflow:hidden; border: solid 1px #cccccc; background-image:url('<% =Me.ResolveUrl("~/design/gfx/check.gif") %>');">    
        ...
        <script type="text/javascript">
            ...
            {
                var result = null;
                $("#<% =Me.ddlImageFormat.ClientID %>").children("option").each(function()
                {
                    var ext = $(this).val();
            ...
            function imageFormatChange(useAnimation)
            {
                ...
                var oNewImageFormatDiv = $("#outputImageFormat_" + $("#<% =Me.ddlImageFormat.ClientID %>").val());
            ...
            function initializeExampleUI()
            {
                $("#jpegQualitySlider").slider({
                    ...
                    {
                        $("#<% =Me.txtJpegQuality.ClientID %>").val(ui.value);
                    },
                    animate: true,
                    value: parseInt($("#<% =Me.txtJpegQuality.ClientID %>").val())
                });

                $("#<% =Me.ddlImageFormat.ClientID %>").change(function()
                {

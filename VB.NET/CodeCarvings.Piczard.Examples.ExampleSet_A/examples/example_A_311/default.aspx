<%@ Page Title="Piczard Examples | Web - PictureTrimmer | InlinePictureTrimmer | Overview" Language="VB" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="examples_example_A_311_default" %>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                <div class="InlinePanel1" style="padding:5px; margin-bottom:10px;">
                    ...
                    &nbsp;&nbsp;
                    <asp:Button runat="server" ID="btnEnable" Text="Enable/Disable" CausesValidation="false" />
                    <asp:Button runat="server" ID="btnShow" Text="Show/Hide" CausesValidation="false" />
                </div>

<%@ Page Title="Piczard Examples | Web - PictureTrimmer | Load & save images and values" Language="VB" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="examples_example_A_305_default" %>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                ...
                <div>
                    ...
                    <br />
                    <asp:LinkButton runat="server" ID="lbEdit2" CausesValidation="false">
                    ...
                    ShowImageAdjustmentsPanel="true" Culture="en" AutoFreezeOnFormSubmit="true"
                    AutoPostBackOnPopupClose="Always" />                         
                    <asp:Button runat="server" ID="btnEdit2" Text="  Edit Picture  " CausesValidation="false" />                              
                    ...
                    <br />
                    <asp:LinkButton runat="server" ID="lbEdit3" CausesValidation="false" >
                    ...
                    ShowImageAdjustmentsPanel="true" Culture="en" AutoFreezeOnFormSubmit="true"
                    AutoPostBackOnPopupClose="Always" />                         
                    <asp:Button runat="server" ID="btnEdit3" Text="  Edit Picture  " CausesValidation="false" />  

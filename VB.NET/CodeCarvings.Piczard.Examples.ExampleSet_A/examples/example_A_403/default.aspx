<%@ Page Title="Piczard Examples | Customize Piczard | Customize layout" Language="VB" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="false" CodeFile="default.aspx.vb" Inherits="examples_example_A_403_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageBody" Runat="Server">
    <div class="pageContainer">
        ...
        <script type="text/javascript">
            ...
            {
                var popupSizeMode = $("#<% =Me.ddlPopupSizeMode.ClientID %>").val();
            ...
            {
                // Background color
                var hexValue = $("#<% =Me.txtBackColor.ClientID %>").val();
                ...
                $("#divBackColor").ColorPicker({
                    ...
                    onHide: function(colpkr)
                    {
                        ...
                        {
                            <% =Me.ClientScript.GetPostBackEventReference(Me.txtBackColor, "OnTextChanged", false) %>
                        });
                        return false;
                    },
                    ...
                    {
                        var hexValue = "#" + hex;
                        $("#<% =Me.txtBackColor.ClientID %>").val(hexValue);
                        $("#divBackColor div").css("backgroundColor", hexValue);
                    }
                });            
                
                // Foreground color
                hexValue = $("#<% =Me.txtForeColor.ClientID %>").val();
                ...
                $("#divForeColor").ColorPicker({
                    ...
                    onHide: function(colpkr)
                    {
                        $(colpkr).fadeOut(500, function()
                        {
                            <% =Me.ClientScript.GetPostBackEventReference(Me.txtForeColor, "OnTextChanged", false) %>
                        });
                        return false;
                    },
                    onChange: function(hsb, hex, rgb)
                    {
                        var hexValue = "#" + hex;
                        $("#<% =Me.txtForeColor.ClientID %>").val(hexValue);
                        $("#divForeColor div").css("backgroundColor", hexValue);
                    }
                });
            
                // Canvas color
                hexValue = $("#<% =Me.txtCanvasColor.ClientID %>").val();
                ...
                // Image back color
                hexValue = $("#<% =Me.txtImageBackColor.ClientID %>").val();
                ...
                $("#divImageBackColor").ColorPicker({
                    ...
                    onHide: function(colpkr)
                    {
                        $(colpkr).fadeOut(500, function()
                        {
                            <% =Me.ClientScript.GetPostBackEventReference(Me.txtImageBackColor, "OnTextChanged", false) %>
                        });
                        return false;
                    },
                    onChange: function(hsb, hex, rgb)
                    {
                        var hexValue = "#" + hex;
                        $("#<% =Me.txtImageBackColor.ClientID %>").val(hexValue);
                        $("#divImageBackColor div").css("backgroundColor", hexValue);
                    }
                });
            }

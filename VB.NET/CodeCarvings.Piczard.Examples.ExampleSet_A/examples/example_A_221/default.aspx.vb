...
Partial Class examples_example_A_221_default
    ...
    Protected Sub ProcessImage()
        ...
        Dim outputImageFileName As String = "~/repository/output/Ex_A_221.jpg"

        ' Setup the image selection filter
        Dim imageTransformation As ImageTransformation = New ImageTransformation()
        imageTransformation.RotationAngle = Single.Parse(Me.ddlRotationAngle.SelectedValue, System.Globalization.CultureInfo.InvariantCulture)
        imageTransformation.FlipH = Me.cbFlipH.Checked
        imageTransformation.FlipV = Me.cbFlipV.Checked
    ...
    Protected Sub DisplayCode()
        ...
        sbCode.Append("Dim outputImage As String = ""~/repository/output/Ex_A_221.jpg""" + crlf)
        sbCode.Append(crlf)
        ...
        If ((Single.Parse(Me.ddlRotationAngle.SelectedValue, System.Globalization.CultureInfo.InvariantCulture) <> 0.0F) _
            Or _
            ((Not Me.cbFlipH.Checked) And (Not Me.cbFlipV.Checked))) Then
            sbCode.Append("imageTransformation.RotationAngle = " + Me.ddlRotationAngle.SelectedValue + "F" + crlf)
        End If
        If (Me.cbFlipH.Checked) Then
            sbCode.Append("imageTransformation.FlipH = True" + crlf)
        End If
        If (Me.cbFlipV.Checked) Then

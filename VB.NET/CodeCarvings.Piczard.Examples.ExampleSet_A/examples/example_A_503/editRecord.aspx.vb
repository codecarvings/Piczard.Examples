...
Partial Class examples_example_A_503_editRecord
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Not Me.IsPostBack) Then
            ...
            ' Setup the Picture1 CropConstraint and the Preview filter
            Me.Picture1.CropConstraint = New FixedCropConstraint(300, 300)
            Me.Picture1.CropConstraint.DefaultImageSelectionStrategy = CropConstraintImageSelectionStrategy.WholeImage
            Me.Picture1.PreviewFilter = Nothing 'Use the selected image
                        ...
                        Using reader As OleDbDataReader = command.ExecuteReader()
                            If (reader.Read()) Then
                                ...
                                If (Not String.IsNullOrEmpty(Me.Picture1FileName_upload)) Then
                                    ...
                                    Dim picture1FilePath_upload As String = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_503/picture1/upload/"), Me.Picture1FileName_upload)
...
#End Region
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If (Me.RecordId <> 0) Then
            ...
            If ((Not Me.Picture1.HasImage) Or (Me.Picture1.HasNewImage)) Then
                ...
                If (Not String.IsNullOrEmpty(Me.Picture1FileName_upload)) Then
                    ...
                    Dim picture1FilePath_main As String = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_503/picture1/main/"), Me.Picture1FileName_main)
                    ...
                    Dim picture1FilePath_thumbnail As String = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_503/picture1/thumbnail/"), Me.Picture1FileName_thumbnail)
        ...
        If (Me.Picture1.HasNewImage) Then
            ...
            Dim picture1folderPath_upload As String = Server.MapPath("~/repository/store/ex_A_503/picture1/upload/")
            ...
            Dim picture1folderPath_main As String = Server.MapPath("~/repository/store/ex_A_503/picture1/main/")
            ...
            Dim picture1folderPath_thumbnail As String = Server.MapPath("~/repository/store/ex_A_503/picture1/thumbnail/")
            ' Get the original file name (but always use the .jpg extension)

...
<div class="NavMenu_Container2">
   <button id="btnHome" onclick="document.location.href='<% =this.ResolveUrl("~/default.aspx") %>'; return false;">Back to the Index</button>
</div>
...
<script type="text/javascript">
    ...
    $(function()
    {
        ...
        $("#navMenu").accordion({ header: "h3", fillSpace: true, active: <% =this.RenderAccordianActive() %> });

<%@ Page Title="Piczard Examples | Web - Image Upload Demos | SimpleImageUpload Control | Usage example #2" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_503_default" %>
    ...
    <div class="pageContainer">
        ...
        <div style="border:solid 1px #54691d; padding:10px;">
            ...
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="<%$ ConnectionStrings:Db1ConnectionString %>"
                ...
                DeleteCommand="DELETE FROM [Ex_A_503] WHERE [Id]=@Id" OnDeleting="AccessDataSource1_Deleting" >
                <DeleteParameters>

...
public partial class examples_example_A_503_default : System.Web.UI.Page
{
    ...
    protected void AccessDataSource1_Deleting(object sender, SqlDataSourceCommandEventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(picture1FileName))
        {
            ...
            string picture1FilePath_upload = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_503/picture1/upload/"), picture1FileName);
            ...
            string picture1FilePath_main = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_503/picture1/main/"), picture1FileName);
            ...
            string picture1FilePath_thumbnail = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_503/picture1/thumbnail/"), picture1FileName);

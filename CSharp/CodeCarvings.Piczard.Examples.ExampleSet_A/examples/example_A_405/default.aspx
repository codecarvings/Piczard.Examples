<%@ Page Title="Piczard Examples | Customize Piczard | Enrich the PopupPictureTrimmer window" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_405_default" %>
    ...
    <div class="pageContainer">
        ...
        <script type="text/javascript">
            ...
            function clientSideSelectWholeImage()
            {
                ...
                var oPictureTrimmer = CodeCarvings.Wcs.Piczard.PictureTrimmer.getControl("<% =this.PopupPictureTrimmer1.ClientID %>");
                ...
                userState.value.imageSelection.crop.rectangle.width = Math.round(<% =this.PopupPictureTrimmer1.SourceImageSize.Width.ToString() %> / 100 * userState.value.imageSelection.transformation.resizeFactor);
                userState.value.imageSelection.crop.rectangle.height = Math.round(<% =this.PopupPictureTrimmer1.SourceImageSize.Height.ToString() %> / 100 * userState.value.imageSelection.transformation.resizeFactor);
            ...
            function serverSideSelectWholeImage()
            {
                ...
                <% =this.ClientScript.GetPostBackEventReference(this.btnSelectWholeImage, "", false) %>     
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>        
                ...
                <div class="InlinePanel1" style="padding:5px; margin-bottom:10px;">
                    <input type="button" value="Open popup" onclick="CodeCarvings.Wcs.Piczard.PictureTrimmer.popup_open('<% =this.PopupPictureTrimmer1.ClientID %>'); return false;" />

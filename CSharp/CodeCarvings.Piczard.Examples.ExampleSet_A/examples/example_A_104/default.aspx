<%@ Page Title="Piczard Examples | Basics | Batch process multiple images" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_104_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageBody" Runat="Server">
    <div class="pageContainer">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">                        
                        ...
                        <tr>
                            <td align="center" valign="top" class="ExampleTableProcessBottomCell ExampleTableText">
                                ...
                                <br />
                                <br />
                                <asp:Button runat="server" ID="btnProcess" Text="Batch process images &raquo;" CausesValidation="false" OnClick="btnProcess_Click" CssClass="ButtonText" /><br />
        ...
        <script type="text/javascript">
            ...
            Galleria.loadTheme('<% =HttpUtility.HtmlAttributeEncode(this.ResolveUrl("~/design/libraries/jquery/aino-galleria/themes/classic/galleria.classic.js")) %>');

<%@ Page Title="Piczard Examples | Web - PictureTrimmer | UserState & PictureTrimmer Value" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_304_default" %>
    ...
    <div class="pageContainer">
        ...
        <script type="text/javascript">
            ...
            function InlinePictureTrimmer1_GetUserState()
            {
                ...
                $("#<% =this.txtUserState_Value_ImageSelection_Transformation.ClientID %>").val(str);
                ...
                $("#<% =this.txtUserState_Value_ImageSelection_Crop.ClientID %>").val(str);
                ...
                $("#<% =this.txtUserState_Value_ImageAdjustments.ClientID %>").val(str);
                ...
                $("#<% =this.txtUserState_UIParams.ClientID %>").val(str);
            }
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                            <tr>
                                ...
                                <td align="left" valign="middle">
                                    <asp:Button runat="server" ID="btnServerSideGetUserState" Text="Get UserState" CausesValidation="false" OnClick="btnServerSideGetUserState_Click" />&nbsp;
                                    <asp:Button runat="server" ID="btnServerSideSetUserState" Text="Set UserState" CausesValidation="false" OnClick="btnServerSideSetUserState_Click" /><br />
                                </td>
                            </tr>
                            <tr>

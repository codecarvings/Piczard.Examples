<%@ Page Title="Piczard Examples | Web - Image Upload Demos | SimpleImageUpload Control | Overview" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_501_default" %>
            ...
            <ContentTemplate>
                ...
                <div style="padding-top:10px;">
                    <div style="float:right; width:400px; text-align:right; padding-bottom: 10px;">
                        ...
                        <asp:Button runat="server" ID="btnPreset_1" Text="Interactive crop" OnClick="btnPreset_1_Click" />
                        <asp:Button runat="server" ID="btnPreset_2" Text="Automatic resize" OnClick="btnPreset_2_Click" />
                    </div>
                ...
                <div class="InlinePanel1" style="padding:5px; margin-bottom:10px;">
                    <div>
                        <div>
                            ...
                            <asp:CheckBox runat="server" ID="cbEnableInteractiveImageProcessing" Checked="true" Text="Enable interactive image processing" AutoPostBack="true" OnCheckedChanged="cbEnableInteractiveImageProcessing_CheckedChanged" /><br />
                            <div style="padding: 10px 0 0 20px;">
                                <asp:DropDownList runat="server" ID="ddlCropConstraintMode" AutoPostBack="true" OnSelectedIndexChanged="ddlCropConstraintMode_SelectedIndexChanged">
                                ...
                                <asp:CheckBox runat="server" ID="cbAutoOpenImageEditPopupAfterUpload" Checked="true" Text="Auto open image edit window after upload" AutoPostBack="true" OnCheckedChanged="cbAutoOpenImageEditPopupAfterUpload_CheckedChanged" /><br />                                
                            </div>
                        ...
                        <div style="margin-top:20px; border-top:solid 1px #80A232; padding-top:5px;">
                            ...
                            <asp:CheckBox runat="server" ID="cbPostProcessing_Resize" Text="Resize image"  AutoPostBack="true" OnCheckedChanged="cbPostProcessing_Resize_CheckedChanged" />                        
                            <asp:CheckBox runat="server" ID="cbPostProcessing_Grayscale" Text="Grayscale" AutoPostBack="true"  OnCheckedChanged="cbPostProcessing_Grayscale_CheckedChanged" />
                            <asp:CheckBox runat="server" ID="cbPostProcessing_Watermark" Text="Apply watermark" AutoPostBack="true" OnCheckedChanged="cbPostProcessing_Watermark_CheckedChanged" /><br />
                            <div style="padding-top:5px;">
                        ...
                        <div style="margin-top:20px; border-top:solid 1px #80A232; padding-top:5px;">
                            ...
                            <asp:CheckBox runat="server" ID="cbPreviewConstriant" Checked="true" Text="Scale preview" AutoPostBack="true" OnCheckedChanged="cbPreviewConstriant_CheckedChanged" /><br /> 
                            <div style="padding-top:5px;">
                        ...
                        <div style="margin-top:20px; border-top:solid 1px #80A232; padding-top:5px; margin-bottom:10px;">
                            ...
                            <asp:CheckBox runat="server" ID="cbValidateImageSize" Text="Validate minimum width of uploaded images" AutoPostBack="true" OnCheckedChanged="cbValidateImageSize_CheckedChanged" /><br />
                            <div style="padding-top:5px;">
                                <asp:TextBox runat="server" ID="txtValidateImageSize" style="width:95%; margin-left:5px; font-family: 'Courier New', Courier, monospace; font-size:12px;" BackColor="Black" ForeColor="LightGreen" BorderStyle="Solid" BorderWidth="2px" BorderColor="Green" TextMode="MultiLine" Rows="12">protected void ImageUpload1_ImageUpload(object sender, SimpleImageUpload.ImageUploadEventArgs args)
{
  if (ImageUpload1.SourceImageSize.Width < 250)
  {

...
public partial class examples_example_A_201_default : System.Web.UI.Page
{
    ...
    protected void DisplayCode()
    {
        ...
        sbCode.Append("string outputImage = \"~/repository/output/Ex_A_201.jpg\";" + crlf);
        sbCode.Append(crlf);
        ...
        sbCode.Append("imageTransformation.ResizeFactor = " + this.ddlResizeFactor.SelectedValue + "F;" + crlf);

<%@ Page Title="Piczard Examples | Web - Image Upload Demos | SimpleImageUpload Control | Usage example #5" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_506_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageBody" Runat="Server">
    <div class="pageContainer">
        <CommonUC:PageTitle runat="server" ID="PageTitle" MacroAreaID="5" Title="A.506 - SimpleImageUpload Control - Usage example #5" />
        ...
        <div style="border:solid 1px #54691d; padding:10px;">
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                <Columns>
	                ...
	                <asp:ImageField HeaderText="Preview" DataImageUrlField="Picture1_FileName_thumbnail" DataImageUrlFormatString="~/repository/store/ex_A_506/picture1/thumbnail/{0}"
            ...
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="<%$ ConnectionStrings:Db1ConnectionString %>"
                SelectCommand="SELECT [Id], [Title], [Picture1_FileName_thumbnail] FROM [Ex_A_506]"
                DeleteCommand="DELETE FROM [Ex_A_506] WHERE [Id]=@Id" OnDeleting="AccessDataSource1_Deleting" >
                <DeleteParameters>
        ...
        <div class="InlinePanel2" style="margin-top:50px;">
            Example A.506 highlights:<br />
            <ul>
                <li>Multiple configurations (portrait and landscape) with automatic detection of the orientation of the uploaded image</li>

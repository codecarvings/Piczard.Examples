...
public partial class examples_example_A_506_default : System.Web.UI.Page
{
    ...
    protected void AccessDataSource1_Deleting(object sender, SqlDataSourceCommandEventArgs e)
    {
        ...
        using (OleDbConnection connection = ExamplesHelper.GetNewOpenDbConnection())
        {
            ...
            {
                command.CommandText = "SELECT [Picture1_FileName_thumbnail] FROM [Ex_A_506] WHERE [ID]=@Id";
        ...
        if (!string.IsNullOrEmpty(picture1FileName))
        {
            ...
            string picture1FilePath_upload = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_506/picture1/upload/"), picture1FileName);
            ...
            string picture1FilePath_main = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_506/picture1/main/"), picture1FileName);
            ...
            string picture1FilePath_thumbnail = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_506/picture1/thumbnail/"), picture1FileName);

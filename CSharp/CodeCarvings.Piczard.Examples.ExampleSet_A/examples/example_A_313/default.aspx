<%@ Page Title="Piczard Examples | Web - PictureTrimmer | InlinePictureTrimmer | Client side events" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_313_default" %>
    ...
    <div class="pageContainer">
        ...
        <script type="text/javascript">
            ...
            function myLog(message)
            {
                ...
                var oTxtMyLog = $("#<% =this.txtMyLog.ClientID %>");

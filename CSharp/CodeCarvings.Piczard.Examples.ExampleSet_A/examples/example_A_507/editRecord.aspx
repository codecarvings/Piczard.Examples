<%@ Page Title="Piczard Examples | Web - Image Upload Demos | SimpleImageUpload Control | Usage example #6 (image resize + watermark) | Edit record" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="editRecord.aspx.cs" Inherits="examples_example_A_507_editRecord" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageBody" Runat="Server">
    <div class="pageContainer">
        <CommonUC:PageTitle runat="server" ID="PageTitle" MacroAreaID="5" Title="A.507 - SimpleImageUpload Control - Usage example #6 (image resize + watermark) - Edit record" />
        ...
        <script type="text/javascript">
            ...
            function fvPicture1_Validate(sender, args)
            {
                ...
                args.IsValid = CodeCarvings.Wcs.Piczard.Upload.SimpleImageUpload.get_hasImage("<% =CodeCarvings.Piczard.Web.Helpers.JSHelper.EncodeString(this.Picture1.ClientID) %>"); ;
            }
                ...
                <div class="EditBox">
                    <table border="0" cellpadding="2" cellspacing="0" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td align="left" valign="middle">
                                <ccPiczardUC:SimpleImageUpload ID="Picture1" runat="server" Width="414px" EnableEdit="false" />
                            </td>
                            <td align="left" valign="middle">
                                <asp:CustomValidator runat="server" ID="fvPicture1" ClientValidationFunction="fvPicture1_Validate" OnServerValidate="fvPicture1_ServerValidate" ErrorMessage="* Required field"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" valign="top">
                                ...
                                <br />
                                <br />
                                <asp:Button runat="server" ID="btnSave" Text="Save" CausesValidation="true" OnClick="btnSave_Click" OnClientClick="if (!btnSave_clientClick()) return false;" />

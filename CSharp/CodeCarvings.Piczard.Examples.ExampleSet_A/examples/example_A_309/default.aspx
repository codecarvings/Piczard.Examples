<%@ Page Title="Piczard Examples | Web - PictureTrimmer | Cropping Landscape and Portrait images" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_309_default" %>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                ...
                <div class="InlinePanel1" style="padding:5px; margin-bottom:10px;">
                    <asp:Button runat="server" ID="btnLoadLandscape" Text="Load a Landscape image" OnClick="btnLoadLandscape_Click" CausesValidation="false" />
                    <asp:Button runat="server" ID="btnLoadPortrait" Text="Load a Portrait image" OnClick="btnLoadPortrait_Click" CausesValidation="false" />
                    &nbsp;&nbsp;&nbsp;
                    <asp:Button runat="server" ID="btnProcessImage" Text="Preview &raquo;" OnClick="btnProcessImage_Click" Enabled="false" CausesValidation="false" />
                </div>
            
                <div style="border: solid 1px #cccccc; background-color: #e6e6e6; color: #000000; width:632px">
                    <div style="padding:5px; text-align:right;">
                        Image orientation: 
                        <asp:DropDownList runat="server" ID="ddlCropOrientation" AutoPostBack="true" Enabled="false" OnSelectedIndexChanged="ddlCropOrientation_SelectedIndexChanged">

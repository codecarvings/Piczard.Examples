<%@ Page Title="Piczard Examples | Web - PictureTrimmer | PopupPictureTrimmer | Server side Events" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_322_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageBody" Runat="Server">
    <div class="pageContainer">
        <CommonUC:PageTitle runat="server" ID="PageTitle" MacroAreaID="3" Title="A.322 - PopupPictureTrimmer - Server side Events" />
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
            <ContentTemplate>
                ...
                OnPopupClose="PopupPictureTrimmer1_PopupClose"
                OnValueChanged="PopupPictureTrimmer1_ValueChanged" />
                ...
                <div class="InlinePanel1" style="padding:5px; margin-bottom:10px;">
                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                        ...
                        <tr>
                            <td align="left" valign="middle" style="height:38px;">
                                <span class="ExampleTableText">
                                    Auto postback mode:<br />
                                </span>
                            </td>
                            <td align="left" valign="middle">
                                <asp:DropDownList runat="server" ID="ddlAutoPostBackMode" AutoPostBack="true">
                                    <asp:ListItem Value="Always" Text="Always" Selected="True"></asp:ListItem>
                                    <asp:ListItem Value="OnlyOnSave" Text="OnlyOnSave"></asp:ListItem>
                                    <asp:ListItem Value="OnlyOnCancel" Text="OnlyOnCancel"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>

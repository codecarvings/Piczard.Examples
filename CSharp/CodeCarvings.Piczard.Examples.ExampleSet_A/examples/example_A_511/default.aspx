<%@ Page Title="Piczard Examples | Web - Image Upload Demos | Programmatic image processing | Default file upload #1" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_511_default" %>
    ...
    <div class="pageContainer">
        ...
        <div style="border:solid 1px #54691d; padding:10px;">
            ...
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="<%$ ConnectionStrings:Db1ConnectionString %>"
                ...
                DeleteCommand="DELETE FROM [Ex_A_511] WHERE [Id]=@Id" OnDeleted="AccessDataSource1_Deleted" >
                <DeleteParameters>

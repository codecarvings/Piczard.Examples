...
public partial class examples_example_A_511_default : System.Web.UI.Page
{
    ...
    protected void AccessDataSource1_Deleted(object sender, SqlDataSourceStatusEventArgs e)
    {
        ...
        string picture1FilePath_main = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_511/picture1/main/"), picture1FileName);
        ...
        string picture1FilePath_thumbnail = System.IO.Path.Combine(Server.MapPath("~/repository/store/ex_A_511/picture1/thumbnail/"), picture1FileName);

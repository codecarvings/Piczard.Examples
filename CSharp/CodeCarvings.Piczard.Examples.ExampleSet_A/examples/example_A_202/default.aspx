<%@ Page Title="Piczard Examples | Image manipulation | Resize an image | Automatic" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_202_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pageBody" Runat="Server">
    <div class="pageContainer">
        ...
        <script type="text/javascript">
            ...
            {
                var hexValue = $("#<% =this.txtFixedCanvasColor.ClientID %>").val();
                ...
                $("#divFixedCanvasColor").ColorPicker({
                    ...
                    onHide: function(colpkr)
                    {
                        ...
                        {
                            <% =this.ClientScript.GetPostBackEventReference(this.txtFixedCanvasColor, "OnTextChanged", false) %>
                        });
                        return false;
                    },
                    ...
                    {
                        var hexValue = "#" + hex;
                        $("#<% =this.txtFixedCanvasColor.ClientID %>").val(hexValue);
                        $("#divFixedCanvasColor div").css("backgroundColor", hexValue);
                    }
                });
            }

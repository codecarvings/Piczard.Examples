<%@ Page Title="Piczard Examples | Basics | Use multiple image filters" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_102_default" %>
                ...
                {            
                    ...
                    $("#sortableFilters").sortable({
                        update: function(event, ui)
                        {
                            ...
                            $("#<% =this.hfFilterList.ClientID %>").val(result.join(","));
                            
                            <% =this.ClientScript.GetPostBackEventReference(this.lbDragRefresh, "", false) %>
                        }
                    });
                    $("#sortableFilters").disableSelection();
                    
                    // Restore the filter order
                    var itemIDS = $("#<% =this.hfFilterList.ClientID %>").val().split(",");                          

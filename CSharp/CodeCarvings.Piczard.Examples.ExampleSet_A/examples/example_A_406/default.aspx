<%@ Page Title="Piczard Examples | Customize Piczard | Real time crop preview" Language="C#" MasterPageFile="~/design/masters/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="examples_example_A_406_default" %>
    ...
    <div class="pageContainer">
        ...
        <script type="text/javascript">
            ...
            function updatePreview()
            {
                ...
                var sourceImageWidth = <% =this.InlinePictureTrimmer1.SourceImageSize.Width.ToString() %>;
                var sourceImageHeight = <% =this.InlinePictureTrimmer1.SourceImageSize.Height.ToString() %>;
                ...
                var previewData = CodeCarvings.Wcs.Piczard.Shared.Externals.JSON.stringify({
                    image: "<% =CodeCarvings.Piczard.Helpers.SecurityHelper.EncryptString(this.SourceImageFilePath) %>",
